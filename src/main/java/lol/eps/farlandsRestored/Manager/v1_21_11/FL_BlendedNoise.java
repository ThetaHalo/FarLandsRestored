...
public class FLA_BlendedNoise extends BlendedNoise {
    ...
    private final FLRestoredOptions configValues;
    ...
    public FLA_BlendedNoise(PerlinNoise var0, PerlinNoise var1, PerlinNoise var2, NoiseSamplingSettings var3, int var4,
                            int var5, RandomSource randomSource, FLRestoredOptions configValues, int divisor) {
        ...
        if(this.configValues != null) {
            this.highX = configValues.getHighX() / 1;
            this.highZ = configValues.getHighZ() / 1;
            this.lowX = configValues.getLowX() / 1;
            this.lowZ = configValues.getLowZ() / 1;
        } else {
